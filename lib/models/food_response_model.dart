...
List<FoodResponseModel> foodResponseModelFromJson(String str) => List<FoodResponseModel>.from(json.decode(str).map((x) => FoodResponseModel.fromJson(x)));

String foodResponseModelToJson(List<FoodResponseModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
